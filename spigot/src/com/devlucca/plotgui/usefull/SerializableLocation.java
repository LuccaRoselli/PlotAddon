 ...
 * 
 * @author Pandemoneus - [url]https://github.com/Pandemoneus[/url]
 */
public final class SerializableLocation implements Serializable {
     ...
     */
    public static SerializableLocation getMTLocationFromLocation(Location loc) {
        SerializableLocation result = null;
 
        if (loc != null) {
            result = new SerializableLocation(loc.getWorld().getName(), loc.getBlockX(), loc.getBlockY(), loc.getBlockZ());
        }
